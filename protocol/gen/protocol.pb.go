...
func (x *CreateUserV2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateUserV2) ProtoMessage() {}

func (x *CreateUserV2) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_protocol_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateUserV2.ProtoReflect.Descriptor instead.
func (*CreateUserV2) Descriptor() ([]byte, []int) {
	return file_protocol_protocol_proto_rawDescGZIP(), []int{1}
}

func (x *CreateUserV2) GetHandle() string {
	if x != nil {
		return x.Handle
	}
	return ""
...
func (x *CreateUserV2) GetBio() string {
	if x != nil {
		return x.Bio
	}
	return ""
...
var file_protocol_protocol_proto_rawDesc = []byte{
	...
	0x0a, 0x0a, 0x45, 0x6e, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x56, 0x32, 0x12, 0x12, 0x0a, 0x04,
	...
	0x72, 0x65, 0x22, 0x38, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
	0x56, 0x32, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x62, 0x69,
	0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x62, 0x69, 0x6f, 0x22, 0x61, 0x0a, 0x08,
	...
	0x50, 0x4f, 0x53, 0x54, 0x5f, 0x54, 0x52, 0x41, 0x43, 0x4b, 0x10, 0x06, 0x42, 0x0b, 0x5a, 0x09,
	0x2e, 0x2f, 0x67, 0x65, 0x6e, 0x3b, 0x67, 0x65, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_protocol_protocol_proto_goTypes = []interface{}{
	...
	(*CreateUserV2)(nil),       // 2: protocol.CreateUserV2
	(*Envelope)(nil),           // 3: protocol.Envelope
	(*Headers)(nil),            // 4: protocol.Headers
	(*CreateUser)(nil),         // 5: protocol.CreateUser
	(*FollowUser)(nil),         // 6: protocol.FollowUser
	(*UnfollowUser)(nil),       // 7: protocol.UnfollowUser
	(*CreateTrack)(nil),        // 8: protocol.CreateTrack
	(*RepostTrack)(nil),        // 9: protocol.RepostTrack
	(*UnrepostTrack)(nil),      // 10: protocol.UnrepostTrack
	(*CreateUser_Data)(nil),    // 11: protocol.CreateUser.Data
	(*FollowUser_Data)(nil),    // 12: protocol.FollowUser.Data
	(*UnfollowUser_Data)(nil),  // 13: protocol.UnfollowUser.Data
	(*CreateTrack_Data)(nil),   // 14: protocol.CreateTrack.Data
	(*RepostTrack_Data)(nil),   // 15: protocol.RepostTrack.Data
	(*UnrepostTrack_Data)(nil), // 16: protocol.UnrepostTrack.Data
	(*anypb.Any)(nil),          // 17: google.protobuf.Any
}
var file_protocol_protocol_proto_depIdxs = []int32{
	4,  // 0: protocol.Envelope.headers:type_name -> protocol.Headers
	17, // 1: protocol.Envelope.data:type_name -> google.protobuf.Any
	0,  // 2: protocol.Headers.message_type:type_name -> protocol.MessageType
	4,  // 3: protocol.CreateUser.headers:type_name -> protocol.Headers
	11, // 4: protocol.CreateUser.data:type_name -> protocol.CreateUser.Data
	4,  // 5: protocol.FollowUser.headers:type_name -> protocol.Headers
	12, // 6: protocol.FollowUser.data:type_name -> protocol.FollowUser.Data
	4,  // 7: protocol.UnfollowUser.headers:type_name -> protocol.Headers
	13, // 8: protocol.UnfollowUser.data:type_name -> protocol.UnfollowUser.Data
	4,  // 9: protocol.CreateTrack.headers:type_name -> protocol.Headers
	14, // 10: protocol.CreateTrack.data:type_name -> protocol.CreateTrack.Data
	4,  // 11: protocol.RepostTrack.headers:type_name -> protocol.Headers
	15, // 12: protocol.RepostTrack.data:type_name -> protocol.RepostTrack.Data
	4,  // 13: protocol.UnrepostTrack.headers:type_name -> protocol.Headers
	16, // 14: protocol.UnrepostTrack.data:type_name -> protocol.UnrepostTrack.Data
