...
const (
	BroadcastAPI_Ping_FullMethodName        = "/cometbft.rpc.grpc.v1beta1.BroadcastAPI/Ping"
	BroadcastAPI_BroadcastTx_FullMethodName = "/cometbft.rpc.grpc.v1beta1.BroadcastAPI/BroadcastTx"
)
