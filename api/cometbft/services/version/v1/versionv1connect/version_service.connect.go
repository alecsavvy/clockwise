...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/alecsavvy/clockwise/api/cometbft/services/version/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	VersionServiceName = "cometbft.services.version.v1.VersionService"
)
...
const (
	...
	// RPC.
	VersionServiceGetVersionProcedure = "/cometbft.services.version.v1.VersionService/GetVersion"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	versionServiceServiceDescriptor          = v1.File_cometbft_services_version_v1_version_service_proto.Services().ByName("VersionService")
	versionServiceGetVersionMethodDescriptor = versionServiceServiceDescriptor.Methods().ByName("GetVersion")
)

// VersionServiceClient is a client for the cometbft.services.version.v1.VersionService service.
...
// NewVersionServiceClient constructs a client for the cometbft.services.version.v1.VersionService
...
// GetVersion calls cometbft.services.version.v1.VersionService.GetVersion.
...
// VersionServiceHandler is an implementation of the cometbft.services.version.v1.VersionService
// service.
...
func NewVersionServiceHandler(svc VersionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/cometbft.services.version.v1.VersionService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedVersionServiceHandler) GetVersion(context.Context, *connect.Request[v1.GetVersionRequest]) (*connect.Response[v1.GetVersionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("cometbft.services.version.v1.VersionService.GetVersion is not implemented"))
}
